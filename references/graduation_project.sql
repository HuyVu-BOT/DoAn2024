...
CREATE TABLE `employee` (
  ...
  KEY `created_by_idx` (`created_by`,`department_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `recognition_log`
--
...
--
-- Dumping data for table `recognition_log`
--

LOCK TABLES `recognition_log` WRITE;
/*!40000 ALTER TABLE `recognition_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `recognition_log` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-02-29 16:40:03
